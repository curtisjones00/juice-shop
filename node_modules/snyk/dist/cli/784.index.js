...
function formatIacTestSummary(testData, outputMeta) {
    const title = chalk_1.default.bold.white('Test Summary');
...
function formatCountsSection(testData) {
    ...
    countsSectionProperties.push(`${chalk_1.default.bold(theme_1.color.status.success(theme_1.icon.VALID))} Files without issues: ${chalk_1.default.bold.white(`${filesWithoutIssues}`)}`);
    countsSectionProperties.push(`${chalk_1.default.bold(theme_1.color.status.error(theme_1.icon.ISSUE))} Files with issues: ${chalk_1.default.bold.white(`${filesWithIssues}`)}`);
    countsSectionProperties.push(`${INDENT}Ignored issues: ${chalk_1.default.bold.white(`${testData.ignoreCount}`)}`);
    ...
    countsSectionProperties.push(`${INDENT}Total issues: ${chalk_1.default.bold.white(`${totalIssuesCount}`)} [ ${color_utils_1.severityColor.critical(`${issueCountsBySeverities.critical} critical`)}, ${color_utils_1.severityColor.high(`${issueCountsBySeverities.high} high`)}, ${color_utils_1.severityColor.medium(`${issueCountsBySeverities.medium} medium`)}, ${color_utils_1.severityColor.low(`${issueCountsBySeverities.low} low`)} ]`);
